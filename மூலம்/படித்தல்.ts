...
import {எழுத்து_மாறு} from './மாற்றம்.js';
...
export function படி({கைரேகை}: {கைரேகை: string}): {
  ...
  const மாற்றி =
    இலாத்தின்_அடைப்புகள்[குறிமுறை as keyof typeof இலாத்தின்_அடைப்புகள்];

  const இலாத்தின்_கைரேகை = எழுத்து === 'ltn' ? கைரேகை : எழுத்து_மாறு({
    கைரேகை,
    எழுத்து: 'ltn',
  });
